...
public class RefundActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnprint= findViewById(R.id.btnpost3);
...
//            textdeskripsi.setText(produk.getDeskripsiProduk());
    ...
    private void sendAudit() {
        ...
        Call<ModelPost> postAdd = apiInterface.sendAudit(
                ...
                (AppUtil.replaceNull("Refund Dana Rp " + saldoakhir)),
                (AppUtil.replaceNull("Rp " + String.valueOf(saldoakhir))),
        ...
        postAdd.enqueue(new Callback<ModelPost>() {
            ...
            public void onResponse(Call<ModelPost> call, Response<ModelPost> response) {
                ...
                if (responServer != null) {
                    Toast.makeText(RefundActivity.this,"Refund has been successful", Toast.LENGTH_LONG).show();
                }
                Intent a = new Intent(RefundActivity.this, MainActivity.class);
                startActivity(a);
            }
            ...
            public void onFailure(Call<ModelPost> call, Throwable t) {
                ...
                Toast.makeText(RefundActivity.this, "Connection Error", Toast.LENGTH_LONG).show();
                call.cancel();
        ...
        try {
            ...
            if (lsdata!=null){
                if(lsdata.length>1){
                    ...
                    Toast.makeText(RefundActivity.this,"NFC No Detected",Toast.LENGTH_SHORT).show();
                }
            }
...
//        Log.d(TAG, "onNewIntent: "+intent.getAction());
        ...
        if (tag != null) {
            ...
            try{
                saldoakhir = Integer.parseInt(nfcData[1]);
            } catch(Exception e){

            }

            try {
                credit = Integer.parseInt(nfcData[1].replace(".", "")) - saldoakhir;
            } catch (Exception e){
